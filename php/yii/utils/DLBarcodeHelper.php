 ...
 *
 */
class DLBarcodeHelper
{
    public $barcode = 'davidhhuan';
    public $width = 410;
    public $height = 59;
    public $quality = 100;
    public $format = 'JPEG';
     ...
     *
     * @param ImageCreate $im
     * @param string $format: The type of image you want to create, for example, jpeg, png, gif
     * @param int $quality
     */
     ...
     *
     * @param string $Asc: ASCII character
     */
    function code39 ($Asc)
    {
        switch ($Asc)
