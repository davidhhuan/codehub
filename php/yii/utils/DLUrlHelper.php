...
class DLUrlHelper
{
	/**
	 *
	 * This is used to make the url more clean.
	 * change the blank to dash. 
	 * change the un-ascii code to ascii, such as Œ to OE, À to A and so on. Remove the unsafe symbols such as &%$#@
	 example: 
	 <pre>
	 echo DLUrlHelper::cleanString("我爱 中文！");
	 </pre>
	 *
	 * @author davidhhuan
	 */
